...
async function main() {
  ...
  const proxyAdminV2 = new ethers.Contract(adminProxyContract.target, adminV2Json.abi, owner);
  let versionAfter = await proxyAdminV2.version();
  ...
  storage = await provider.getStorage(proxyAdminV2, implSlot);
  ...
  const proxyBridgeV2 = new ethers.Contract(bridgeProxyContract.target, bridgeV2Json.abi, owner);
  versionAfter = await proxyBridgeV2.version();
  console.log("Bridge version after upgrade", versionAfter);
  implSlot = "0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc";
  storage = await provider.getStorage(proxyBridgeV2, implSlot);
  implementationAddress = ethers.getAddress("0x" + storage.slice(-40));
  ...
  const proxyClaimsV2 = new ethers.Contract(claimsProxyContract.target, claimsV2Json.abi, owner);
  versionAfter = await proxyClaimsV2.version();
  console.log("Claims version after upgrade", versionAfter);
  implSlot = "0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc";
  storage = await provider.getStorage(proxyClaimsV2, implSlot);
  implementationAddress = ethers.getAddress("0x" + storage.slice(-40));
  ...
  const proxyClaimsHelperV2 = new ethers.Contract(claimsHelperProxyContract.target, claimsHelperV2Json.abi, owner);
  versionAfter = await proxyClaimsHelperV2.version();
  console.log("ClaimsHelper version after upgrade", versionAfter);
  implSlot = "0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc";
  storage = await provider.getStorage(proxyClaimsHelperV2, implSlot);
  implementationAddress = ethers.getAddress("0x" + storage.slice(-40));
  ...
  const proxySignedBatchesV2 = new ethers.Contract(signedBatchesProxyContract.target, signedBatchesV2Json.abi, owner);
  versionAfter = await proxySignedBatchesV2.version();
  console.log("SignedBatches version after upgrade", versionAfter);
  implSlot = "0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc";
  storage = await provider.getStorage(proxySignedBatchesV2, implSlot);
  implementationAddress = ethers.getAddress("0x" + storage.slice(-40));
  ...
  const proxySlotsV2 = new ethers.Contract(slotsProxyContract.target, slotsV2Json.abi, owner);
  versionAfter = await proxySlotsV2.version();
  console.log("Slots version after upgrade", versionAfter);
  implSlot = "0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc";
  storage = await provider.getStorage(proxySlotsV2, implSlot);
  implementationAddress = ethers.getAddress("0x" + storage.slice(-40));
